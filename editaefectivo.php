...
$queryu="select * from efectivorobert where idefectivorobert=$idefectivorobert;";	
...
$idefectivorobert=$resultx['idefectivorobert'];
if($valorentrada>0){
	$valor=$valorentrada;
	$opcion=1;
	$nomop="Entrada";
...
<form id="movtienda" action = "editefectivo.php" method = "get"> 
<div class="col-md-2">
<label>Fecha:</label>
...
<input type="number" min="1" id="valor" name="valor" class="form-control input-sm chat-input"value='<?php echo $valor;?>'></input>
  ...
  <input type="hidden" id="idefectivorobert" name="idefectivorobert" value="<?php echo $idefectivorobert;?>"></input>  
