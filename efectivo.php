...
?>
<center><h2>Resumen efectivo</h2></center>

<?php
$queryu="select * from efectivorobert order by fecha,idefectivorobert asc;";	
...
?>
<tr>
<td><a href='editaefectivo.php?idt=<?php echo "$idefectivorobert"; ?>'><?php echo "$fecha"; ?></a></td>
...
<center>
<div class="row">
<form id="movtienda" action = "movefectivo.php" method = "get"> 
<div class="col-md-2">
<label>Fecha:</label>
